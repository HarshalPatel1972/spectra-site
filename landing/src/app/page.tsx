          ...
          <section className="pt-24 pb-32">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 font-sans text-[1rem] leading-[1.6] text-text-secondary max-w-6xl mx-auto">
              <div className="glass-panel p-8 rounded-2xl flex flex-col gap-6">
                <div className="inline-flex w-16 h-16 bg-brand/5 border border-brand/10 items-center justify-center rounded-2xl relative overflow-hidden mb-2 shadow-[0_0_20px_rgba(46,196,196,0.15)]">
                  <div className="absolute inset-0 bg-brand/20 blur-xl opacity-40"></div>
                  <img src="https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Shield/3D/shield_3d.png" alt="Privacy" className="w-10 h-10 relative z-10 drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)]" />
                </div>
              ...
              <div className="glass-panel p-8 rounded-2xl flex flex-col gap-6">
                <div className="inline-flex w-16 h-16 bg-brand/5 border border-brand/10 items-center justify-center rounded-2xl relative overflow-hidden mb-2 shadow-[0_0_20px_rgba(46,196,196,0.15)]">
                  <div className="absolute inset-0 bg-brand/20 blur-xl opacity-40"></div>
                  <img src="https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Magnifying%20glass%20tilted%20right/3D/magnifying_glass_tilted_right_3d.png" alt="Scan" className="w-10 h-10 relative z-10 drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)]" />
                </div>
              ...
              <div className="glass-panel p-8 rounded-2xl flex flex-col gap-6">
                <div className="inline-flex w-16 h-16 bg-brand/5 border border-brand/10 items-center justify-center rounded-2xl relative overflow-hidden mb-2 shadow-[0_0_20px_rgba(46,196,196,0.15)]">
                  <div className="absolute inset-0 bg-brand/20 blur-xl opacity-40"></div>
                  <img src="https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Scroll/3D/scroll_3d.png" alt="Standards" className="w-10 h-10 relative z-10 drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)]" />
                </div>
